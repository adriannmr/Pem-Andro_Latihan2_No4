...
Column(
   ...
   val image = painterResource(id = R.drawable.android_logo)
    Image(painter = image, contentDescription = null, modifier = Modifier
        .height(130.dp)
        .width(150.dp))
    Text(text = stringResource(R.string.name_surname),color = Color.White,fontSize = 35.sp )
    Text(text = stringResource(R.string.business),color = Color(0xFF3ddc84), fontSize = 13.sp)
  ...
  Column(
      ...
      Row(
          modifier = Modifier
              ...
              .fillMaxWidth().padding(start = 0.dp),
